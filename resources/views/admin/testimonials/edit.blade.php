...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h4 class="mb-0">Edit Testimonial: {{ $testimonial->student_name }}</h4>
    </div>
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    @if($testimonial->student_photo)
                        <div class="mb-2">
                            <img src="{{ Storage::url($testimonial->student_photo) }}" class="rounded-circle" style="width:60px; height:60px;">
                        </div>
                    @endif
                ...
                <div class="col-md-6">
                    ...
                    <select name="country_id" class="form-select">
                        ...
                        @foreach($countries as $country)
                            <option value="{{ $country->id }}" {{ old('country_id', $testimonial->country_id) == $country->id ? 'selected' : '' }}>
                                {{ $country->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="university" class="form-control" value="{{ old('university', $testimonial->university) }}">
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="testimonial" rows="4" class="form-control @error('testimonial') is-invalid @enderror" required>{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                    @error('testimonial')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="url" name="video_url" class="form-control" value="{{ old('video_url', $testimonial->video_url) }}">
                </div>
