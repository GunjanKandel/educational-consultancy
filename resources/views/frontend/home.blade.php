    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0 animate-fade-in">
                <h1 class="display-4 fw-bold mb-4">Your Gateway to Global Education</h1>
                <p class="lead mb-4">Transform your future with expert guidance. We help students achieve their dreams of studying abroad in top universities worldwide.</p>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <a href="{{ route('countries.show', $country->slug) }}" class="text-decoration-none">
                    <div class="card country-card text-center h-100">
                        <div class="card-body">
                            @if($country->flag)
                            <img src="{{ Storage::url($country->flag) }}" alt="{{ $country->name }}" class="img-fluid mb-3" style="height: 60px; object-fit: contain;">
                            @else
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card testimonial-card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">"{{ Str::limit($testimonial->testimonial, 150) }}"</p>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="cta-section text-white">
    <div class="container text-center">
        <h2 class="fw-bold mb-4" style="font-size: 2.5rem;">Ready to Start Your Journey?</h2>
        <p class="lead mb-4" style="font-size: 1.2rem;">Join thousands of students who have successfully achieved their study abroad dreams</p>
